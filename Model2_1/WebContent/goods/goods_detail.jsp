...
<script type="text/javascript">
	function isBasket(){
		if(document.gfr.Max_amount.value < document.gfr.amount.value) {
			alert("물품 총 갯수를 초과하셨습니다.");
			document.gfr.amount.focus();
			return;
		}
		if(document.gfr.Max_amount.value=="매진" || document.gfr.Max_amount.value < 0 ) {
			alert("죄송합니다. 매진된 상품입니다.");
			document.gfr.amount.focus();
			return;
		}
...
남은수량 : <input type = "text" name = "Max_amount" value = "
